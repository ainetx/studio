...
You are a Cyber Constructor semantic reviewer for cross-document consistency
...
Open and follow `{cf-constructor-path}/.core/requirements/consistency-checklist.md`
