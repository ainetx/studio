...
def _is_legacy_generator_toml_stub(content: str) -> bool:
    ...
    """
    has_marker = any(
        line.strip().startswith("# Generated by ") and "agents -- do not edit" in line
    ...
    if not has_marker and not has_legacy_follow:
        return False
