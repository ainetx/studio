...
This template routes the next agent to `/cf-constructor-plan` (PHASED review plan) and asks for a
follow-up first-phase execution prompt. The Direct Review template routes to `/cf-constructor-analyze`
