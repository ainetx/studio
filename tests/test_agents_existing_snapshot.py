...
class TestExistingAgentsSnapshot(unittest.TestCase):
    ...
    def test_tuning_table_exact_values(self):
        ...
        expected = {
            ...
            "cf-constructor-migrate-scanner":  ("analyze",  "codebase", "low",    "high"),
            "cf-constructor-migrate-planner":  ("planning", "any",      "high",   "medium"),
            "cf-constructor-migrate-migrator": ("generate", "any",      "low",    "medium"),
            "cf-constructor-migrate-verifier": ("analyze",  "codebase", "low",    "high"),
            "cf-constructor-diff-scope-resolver":        ("analyze",  "any",      "low",    "medium"),
            "cf-constructor-deterministic-validator":     ("analyze",  "any",      "low",    "medium"),
            "cf-constructor-semantic-reviewer-artifact":  ("analyze",  "artifacts","high",   "high"),
            "cf-constructor-semantic-reviewer-code":      ("analyze",  "codebase", "high",   "high"),
            "cf-constructor-code-bug-finder":             ("analyze",  "codebase", "high",   "high"),
            "cf-constructor-semantic-reviewer-prompt":    ("analyze",  "any",      "high",   "high"),
            "cf-constructor-prompt-bug-finder":           ("analyze",  "any",      "high",   "high"),
            "cf-constructor-semantic-reviewer-consistency": ("analyze","any",      "medium", "high"),
            "cf-constructor-brainstorm-facilitator":      ("planning", "any",      "medium", "medium"),
            "cf-constructor-brainstorm-expert":           ("planning", "any",      "medium", "medium"),
            "cf-constructor-generate-collector":          ("planning", "any",      "low",    "medium"),
            "cf-constructor-analyze-planner":             ("planning", "any",      "medium", "medium"),
            "cf-constructor-generate-planner":            ("planning", "any",      "medium", "medium"),
            "cf-constructor-generate-author":             ("planning", "any",      "low",    "medium"),
            "cf-constructor-generate-author-junior":      ("generate", "any",      "low",    "medium"),
            "cf-constructor-generate-author-middle":      ("generate", "any",      "medium", "high"),
            "cf-constructor-generate-author-senior":      ("generate", "any",      "high",   "high"),
            "cf-constructor-generate-author-lead":        ("generate", "any",      "high",   "high"),
            "cf-constructor-generate-coder-casual":       ("generate", "codebase", "medium", "medium"),
            "cf-constructor-generate-coder-smart":        ("generate", "codebase", "high",   "high"),
            "cf-constructor-generate-prompt-engineer-casual": ("generate", "any",  "medium", "medium"),
            "cf-constructor-generate-prompt-engineer-smart":  ("generate", "any",  "high",   "high"),
        }
